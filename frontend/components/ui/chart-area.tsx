...
// Removed Select import to avoid radix icons dependency in environments without it
  ...
  return (
    <Card className="pt-0">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        ...
        {/* Range selector removed for environments without radix-ui icons */}
      </CardHeader>
...
// Single-series Area chart tailored for dashboard integration
